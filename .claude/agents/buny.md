---
name: buny
description: "Use this agent when working with Bun runtime features, optimizing Bun-based tooling, or ensuring idiomatic Bun usage.\n\nExamples:\n\n<example>\nContext: User wants to set up testing.\nuser: \"How should I configure tests for this project?\"\nassistant: \"Let me use the buny agent to set up bun test properly.\"\n</example>\n\n<example>\nContext: Counter-example (NOT buny).\nuser: \"How should I structure my test suite for the domain layer?\"\nassistant: \"That's test design — route to the tesy agent.\"\n</example>"
