...
- [Image telemetry admin contract](project_image_telemetry_admin_contract.md) — UnifiedModelUsageRow + honest ModelUsageSummary (costCoverage discriminant) for image+chat /admin/ai/models; loader-only, drop COALESCE-to-0, extend MODEL_PRICES
