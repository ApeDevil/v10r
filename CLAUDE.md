...
- **arty** (aesthetic — how does each element look?): "visual design", "aesthetics", "color", "typography", "type weight", "contrast", "optical alignment", "stroke weight", "polish", "looks off", "feels off (visual)", "design system fit (color/type)", "component aesthetics" (note: all written words — including microcopy tone, voice, brand naming — go to **cony**, not arty; all spatial arrangement goes to **laly**, not arty)
