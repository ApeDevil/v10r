...
- **arty** (aesthetic — how does it look and feel?): "visual design", "aesthetics", "hierarchy", "spacing", "rhythm", "color", "typography", "polish", "looks off", "feels off", "design system fit", "component aesthetics" (note: all written words — including microcopy tone, voice, brand naming — go to **cony**, not arty)
