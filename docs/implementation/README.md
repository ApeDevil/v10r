...
Records of what was actually built. Each file covers one feature or system — what shipped, what diverged from the plan, and what tripped us up.
...
| [cache.md](./cache.md) | Redis cache showcase, Upstash HTTP client, TTL/ephemeral patterns, rate limiting, data type operations, seed data |
