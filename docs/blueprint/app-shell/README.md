...
| **[ai-assistant.md](./ai-assistant.md)** | • Persistent, minimizable Vely chatbot (non-modal, `chatbot-session` singleton)<br>• Lifecycle (closed/open/minimized), triggers, restore<br>• Site-awareness disclosure chip (see [../ai/site-awareness.md](../ai/site-awareness.md))<br>• Rate limiting, input/output sanitization (XSS, prompt injection)<br>• Streaming and error states |
