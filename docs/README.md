...
| **[stack/](./stack/)** | Technology decisions and vendor choices | • [core.md](./stack/core.md) - runtime, framework, database, ORM<br>• [deployment.md](./stack/deployment.md) - Vercel and Koyeb strategies<br>• [auth.md](./stack/auth.md) - Better Auth vs DIY comparison<br>• [ui.md](./stack/ui.md) - UnoCSS, Bits UI, forms, validation<br>• [api.md](./stack/api.md) - REST, AI SDK, analytics, email<br>• [vendors.md](./stack/vendors.md) - provider matrix and cost analysis |
