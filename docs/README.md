...
| **[foundation/](./foundation/)** | Core project vision, principles, and architecture | • [PRD.md](./foundation/PRD.md) - project concept and goals<br>• [principles.md](./foundation/principles.md) - decision constraints that drive stack choices<br>• [architecture.md](./foundation/architecture.md) - framework-agnostic architecture principles<br>• [self-expressive-project.md](./foundation/self-expressive-project.md) - the codebase and database explain the system; docs explain the why<br>• [explosive-discovery.md](./foundation/explosive-discovery.md) - capability nested by meaning, on a page and across a journey |
