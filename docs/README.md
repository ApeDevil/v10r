...
| **[stack/](./stack/)** | Technology decisions and vendor choices | • [primary/](./stack/primary/) - runtime, framework, database, auth, UI, hosting<br>• [capabilities/](./stack/capabilities/) - API, AI/LLM, SEO, logging, notifications, GDPR<br>• [vendors.md](./stack/vendors.md) - provider matrix and cost analysis |
...
| **[implementation/](./implementation/)** | Implementation records — what shipped, what diverged, what tripped us up | • [database-showcase.md](./implementation/database-showcase.md) - PostgreSQL showcase<br>• [blender3d.md](./implementation/blender3d.md) - Blender → Threlte pipeline<br>• [keyboard-shortcuts.md](./implementation/keyboard-shortcuts.md) - platform-aware shortcuts, sequences, help modal |
