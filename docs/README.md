...
|-----------|---------|-----------|
| **[foundation/](./foundation/)** | Core project vision and architecture principles | • [PRD.md](./foundation/PRD.md) - project concept and goals<br>• [codebase-architecture.md](./foundation/codebase-architecture.md) - SvelteKit structure patterns |
