...
- `src/lib/server/ai/policy/governor.ts` — requiresApproval(risk) — the stated rule; shouldRequirePlan lives in capabilities/desk-plan.ts ([GitHub](https://github.com/ApeDevil/v10r/blob/main/src/lib/server/ai/policy/governor.ts) · [GitLab](https://gitlab.com/ApeDevil/v10r/-/blob/main/src/lib/server/ai/policy/governor.ts))
