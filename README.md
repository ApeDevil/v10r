...
| [Testing infrastructure (Vitest, PGlite isolation)](docs/pattern-library/architecture-testing-infra.md) _(implemented)_ | [blueprint/testing/ai-testing-infrastructure.md](docs/blueprint/testing/ai-testing-infrastructure.md) | [src/lib/server/test/](src/lib/server/test/) · [vitest.config.ts](vitest.config.ts) | — |
