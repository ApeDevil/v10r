...
| [Web push channel (declarative JSON, no PII)](docs/pattern-library/pwa-web-push.md) _(implemented)_ | [blueprint/pwa.md](docs/blueprint/pwa.md) | [src/lib/server/notifications/providers/](src/lib/server/notifications/providers/) | — |
...
| [Markdown editor (CodeMirror, slash commands)](docs/pattern-library/content-markdown-editor.md) | [blueprint/blog.md](docs/blueprint/blog.md) | [src/lib/components/editor/](src/lib/components/editor/) | — (`EditorPanel in the desk workspace desk`) |
...
| Pattern | Docs | Code | Showcase |
|---|---|---|---|
| [**Desk workspace (dock layout, focus architecture, mobile projection)**](docs/pattern-library/desk-workspace.md) | [blueprint/desk/README.md](docs/blueprint/desk/README.md) (The hub: focus architecture, desk effect contract, mobile chrome, Explorer, DeskBus channels) · [blueprint/desk/spreadsheet.md](docs/blueprint/desk/spreadsheet.md) (How a new file-backed panel type joins the workspace) | [src/lib/components/composites/dock/](src/lib/components/composites/dock/) (The whole composite: DockLayout, leaves, tab bars, mobile chrome, state modules) · [src/lib/components/composites/dock/dock.state.svelte.ts](src/lib/components/composites/dock/dock.state.svelte.ts) (Split-tree state: total focus derivation (focusedLeafId → first non-empty leaf fallback), focusSeq counter) · [src/lib/components/composites/dock/dock.operations.ts](src/lib/components/composites/dock/dock.operations.ts) (Pure tree math (split/remove/move) — kept side-effect-free and unit-tested as such) · [src/lib/components/composites/dock/panel-actions.ts](src/lib/components/composites/dock/panel-actions.ts) (focusPanel() — the single focus writer every activation path goes through (tabs, drawer rows, AI effects, deep links)) · [src/lib/components/composites/dock/desk-bus.svelte.ts](src/lib/components/composites/dock/desk-bus.svelte.ts) (Typed pub/sub channels between panels (context-scoped factory, not module state)) · [src/lib/server/desk/](src/lib/server/desk/) (File registry domain module + DockLayoutState valibot schemas) | `/showcases/ui/workbench` · (`/desk`) |
| [Spreadsheet panel (file type, dual-mode)](docs/pattern-library/desk-spreadsheet-panel.md) | [blueprint/desk/spreadsheet.md](docs/blueprint/desk/spreadsheet.md) | [src/lib/components/spreadsheet/](src/lib/components/spreadsheet/) | — (`desk`) |
| [Desk mobile chrome (tab strip + pill + drawers)](docs/pattern-library/desk-mobile-chrome.md) | [blueprint/desk/README.md](docs/blueprint/desk/README.md) (§ Mobile Chrome — control mapping, menu parity, keyboard hiding) | [src/lib/components/composites/dock/DockMobileTabs.svelte](src/lib/components/composites/dock/DockMobileTabs.svelte) (Open-instance tab strip; taps go through focusPanel) · [src/lib/components/composites/dock/dock-mobile.state.svelte.ts](src/lib/components/composites/dock/dock-mobile.state.svelte.ts) (Context-scoped surface discriminator ('panels' | 'commands' | null) + focusSeq auto-close) · [src/lib/state/visual-viewport.svelte.ts](src/lib/state/visual-viewport.svelte.ts) (rAF-coalesced visualViewport watcher with hysteresis → --keyboard-inset + data-keyboard on <html>) | — (`/desk`) |
| [Composed panel menus (one array, desktop kebab + mobile sheet)](docs/pattern-library/desk-panel-menus.md) | [blueprint/desk/README.md](docs/blueprint/desk/README.md) (§ Focus Architecture (registries are followers) + § Mobile Chrome (menu parity rule)) | [src/lib/components/composites/dock/panel-menus.svelte.ts](src/lib/components/composites/dock/panel-menus.svelte.ts) (Context-scoped registry keyed by panel instance id — never module-level) · [src/lib/components/composites/dock/compose-menus.ts](src/lib/components/composites/dock/compose-menus.ts) (composePanelMenus(): registered menus → Panel floor menu → View menu; drops empty registered menus) · [src/lib/components/composites/dock/view-menu.ts](src/lib/components/composites/dock/view-menu.ts) (buildViewMenu({ structural }) — mobile strips split commands) | — (`/desk`) |
| [AI desk effects (tool results drive the workspace)](docs/pattern-library/desk-ai-effects.md) | [blueprint/desk/README.md](docs/blueprint/desk/README.md) (§ Desk Effect Contract + DeskBus ai:* channels) | [src/lib/components/composites/dock/dispatch-desk-effect.ts](src/lib/components/composites/dock/dispatch-desk-effect.ts) (Effect dispatcher over the EffectActions facade; boolean result per effect) · [src/lib/components/composites/dock/io-log.svelte.ts](src/lib/components/composites/dock/io-log.svelte.ts) (I/O Log state — where failed effects surface) | — (`/desk`) |
| [Explorer panel (unified file tree over N sources)](docs/pattern-library/desk-explorer.md) | [blueprint/desk/README.md](docs/blueprint/desk/README.md) (§ Explorer Panel — ExplorerNode, adapters, capability-driven menu) | [src/lib/components/explorer/](src/lib/components/explorer/) · [src/lib/components/explorer/node.ts](src/lib/components/explorer/node.ts) (ExplorerNode + NodeCapability — the unifying interface) · [src/lib/components/explorer/context-menu-items.ts](src/lib/components/explorer/context-menu-items.ts) (Capability-driven menu builder shared by right-click menu and touch kebab) | — (`/desk`) |
