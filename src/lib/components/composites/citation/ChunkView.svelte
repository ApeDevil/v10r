<script lang="ts">
import CitationBadge from '$lib/components/composites/citation/CitationBadge.svelte';
import type { SourceChunk } from '$lib/components/composites/citation/citation-types';
