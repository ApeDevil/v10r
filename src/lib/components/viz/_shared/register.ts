...
export async function registerLineChart() {
	const { Chart, LineController, CategoryScale, LinearScale, PointElement, LineElement, Tooltip, Legend, Filler } =
...
export async function registerPieChart() {
	const { Chart, PieController, DoughnutController, ArcElement, Tooltip, Legend } = await import('chart.js');
...
export async function registerScatterChart() {
	const { Chart, ScatterController, LinearScale, PointElement, Tooltip, Legend } = await import('chart.js');
