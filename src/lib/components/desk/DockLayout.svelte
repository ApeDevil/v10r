...
import type { ActivityBarItem, LayoutNode, PanelDefinition } from '$lib/desk/layout.types';
...
import DockMobileCommandsDrawer from './DockMobileCommandsDrawer.svelte';
...
import { getContextRegistryVersion, setContextFocus } from './desk-context.state.svelte';
import {
...
import { setDeskSettingsContext } from './desk-settings.state.svelte';
