...
export const accordionItemVariants = cva('border-b border-border overflow-hidden', {
	variants: {
		variant: {
			default: '',
...
export const accordionContentVariants = cva('overflow-hidden transition-all duration-normal leading-relaxed', {
	variants: {
		size: {
...
export type AccordionVariants = AccordionItemVariants & AccordionTriggerVariants & AccordionContentVariants;
