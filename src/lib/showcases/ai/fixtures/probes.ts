...
const CHATBOT_INVENTORY: ProbeReport['inventory'] = [
	...
	{ corpus: 'docs', documents: 148, chunks: 3184 },
];
...
const chatbotTrivial: ProbeReport = {
	...
	tools: CHATBOT_TOOLS,
	corpora: [
		{ corpus: 'llmwiki', ran: false, skippedReason: 'gated_off', cutoff: 6, candidates: [] },
		{ corpus: 'docs', ran: false, skippedReason: 'gated_off', cutoff: 4, candidates: [] },
	],
	prompt: {
		blocks: [
...
const chatbotDeixis: ProbeReport = {
	...
	tools: CHATBOT_TOOLS,
	corpora: [
		{ corpus: 'llmwiki', ran: true, cutoff: 6, candidates: [] },
		{
			corpus: 'docs',
			ran: true,
			cutoff: 4,
			candidates: [
				{
					title: 'AI Surfaces',
					preview: 'The chatbot page visualizes the surface’s functional layers: guard, prompt, retrieval, tools…',
					score: 0.743,
					source: 'vector',
					tier: '1',
					chosen: true,
				...
				},
				{
					...
					preview: 'llmwiki pages compile source chunks into TLDR + pointers…',
					score: 0.588,
					source: 'vector',
					tier: '1',
					chosen: true,
...
const deskbotGroundedRead: ProbeReport = {
	...
	inventory: [{ corpus: 'desk', documents: 3, chunks: 41 }],
	tools: DESKBOT_TOOLS,
	corpora: [
		{
			corpus: 'desk',
...
export const PROBE_EXAMPLES: Record<AiSurface, ProbeExample[]> = {
	chatbot: [
