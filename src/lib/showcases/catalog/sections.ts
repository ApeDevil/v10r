...
export const showcaseSections: ShowcaseSection[] = [
	...
	// UI / Workbench
	{ pageHref: '/showcases/ui/dock', anchorId: 'dock-interactive', title: 'Interactive Dock' },
	{ pageHref: '/showcases/ui/dock', anchorId: 'dock-features', title: 'Dock Features' },
	...
	// ── AI surfaces (chatbot + deskbot) — identical anchor set, deliberate ──
	{
		...
		anchorId: 'spine',
		title: 'Request Spine',
		keywords: ['flow', 'orchestrator', 'trace', 'x-ray'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'guard',
		title: 'Guard Chain',
		keywords: ['rate limit', 'budget', 'auth', 'guardAiRequest'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'prompt',
		title: 'Prompt Assembly',
		keywords: ['system prompt', 'cache boundary', 'blocks'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'probe',
	...
	},
	{
		...
		anchorId: 'tools',
		title: 'Tool Harness',
		keywords: ['manifest', 'zero overlap', 'risk'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'verify',
		title: 'Citation Verification',
		keywords: ['citations', 'quote', 'drifted', 'trust'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'stream',
		title: 'Streaming & Fallback',
		keywords: ['providers', '429', 'cooldown', 'leak guard'],
	},
	{
		pageHref: '/showcases/ai/chatbot',
		anchorId: 'awareness',
		title: 'Site-Awareness',
		keywords: ['current page', 'location', 'deixis'],
	},
	{
	...
	},
	{
		...
		anchorId: 'retrieval',
		title: 'Retrieval Profile',
		keywords: ['desk ask', 'own files', 'sync'],
	},
	{
		pageHref: '/showcases/ai/deskbot',
		anchorId: 'tools',
		title: 'Tool Harness',
		keywords: ['desk tools', 'scopes', 'zero overlap'],
	},
	{
		pageHref: '/showcases/ai/deskbot',
		anchorId: 'approval',
		title: 'Approval Lifecycle',
		keywords: ['one door', 'proposal', 'plan card', 'human'],
	},
	{
		pageHref: '/showcases/ai/deskbot',
		anchorId: 'stream',
		title: 'Streaming & Fallback',
		keywords: ['providers', '429', 'cooldown', 'step budget'],
	},
	{
		pageHref: '/showcases/ai/deskbot',
		anchorId: 'awareness',
