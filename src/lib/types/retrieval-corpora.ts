...
export type RetrievalCorpusId = 'map' | 'chunks' | 'catalog' | 'docs';
...
export const RETRIEVAL_CORPORA: RetrievalCorpus[] = [
	{
		id: 'map',
		label: 'corpus map',
		role: 'Deterministic map of a collection, built at ingest — the prompt anchor for broad questions',
		store: 'retrieval.corpus_map',
	},
	{
		id: 'chunks',
		label: 'chunks',
		role: 'Immutable source chunks — what retrieval ranks and the prompt quotes',
