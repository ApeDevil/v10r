 ...
 * the retrieval pipeline uses (`gemini-embedding-001`, 1536-dim) — the honest "this is how
 * retrieval indexes an image: via its description" story. Reuses `generateEmbedding`.
 *
