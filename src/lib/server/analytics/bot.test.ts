/**
 * The bot lane's pure logic: classification, admission, and feed parsing. The shape
 * checks that stand between third-party text and a Postgres cast are the sink's —
 * `db/analytics/inet.test.ts`.
 *
