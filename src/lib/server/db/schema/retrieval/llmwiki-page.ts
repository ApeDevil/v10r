 ...
 * source chunks (via the llmwiki_page_source junction) and carries:
...
export const llmwikiPageKindEnum = retrievalSchema.enum('llmwiki_page_kind', ['overview', 'page']);
...
export const llmwikiPage = retrievalSchema.table(
	'llmwiki_page',
	{
