...
const P1: Palette = {
	...
	light: defineColors({
		...
		'input-bg': 'oklch(0.94 0.03 220)',
		'bg-alpha': 'oklch(0.95 0.03 220 / 0.95)',
		'fg-alpha': 'oklch(0.25 0.06 230 / 0.1)',
		'surface-0': 'oklch(0.95 0.03 220)',
	...
	dark: defineColors({
		...
		'bg-alpha': 'oklch(0.16 0.035 225 / 0.95)',
		'fg-alpha': 'oklch(0.82 0.06 200 / 0.1)',
		'surface-0': 'oklch(0.16 0.035 225)',
...
const P2: Palette = {
	...
	light: defineColors({
		...
		'input-bg': 'oklch(0.95 0.03 55)',
		'bg-alpha': 'oklch(0.96 0.03 60 / 0.95)',
		'fg-alpha': 'oklch(0.25 0.06 30 / 0.1)',
		'surface-0': 'oklch(0.96 0.03 60)',
	...
	dark: defineColors({
		...
		'bg-alpha': 'oklch(0.15 0.035 40 / 0.95)',
		'fg-alpha': 'oklch(0.85 0.05 50 / 0.1)',
		'surface-0': 'oklch(0.15 0.035 40)',
...
const P3: Palette = {
	...
	light: defineColors({
		...
		'input-bg': 'oklch(0.94 0.03 145)',
		'bg-alpha': 'oklch(0.95 0.03 145 / 0.95)',
		'fg-alpha': 'oklch(0.22 0.06 155 / 0.1)',
		'surface-0': 'oklch(0.95 0.03 145)',
	...
	dark: defineColors({
		...
		'bg-alpha': 'oklch(0.15 0.035 150 / 0.95)',
		'fg-alpha': 'oklch(0.82 0.05 140 / 0.1)',
		'surface-0': 'oklch(0.15 0.035 150)',
...
const P4: Palette = {
	...
	light: defineColors({
		...
		'primary-bg': 'oklch(0.88 0.08 135)',
		'primary-fg': 'oklch(0.18 0.08 140)',
		'primary-light': 'oklch(0.68 0.14 135)',
		'on-primary': 'oklch(0.96 0.02 130)',
		'secondary-bg': 'oklch(0.86 0.05 120)',
		'secondary-fg': 'oklch(0.22 0.06 120)',
		'input-border': 'oklch(0.48 0.10 130)',
		'input-bg': 'oklch(0.93 0.06 130)',
		'bg-alpha': 'oklch(0.94 0.08 130 / 0.95)',
		'fg-alpha': 'oklch(0.20 0.06 140 / 0.1)',
		'surface-0': 'oklch(0.94 0.08 130)',
	...
	dark: defineColors({
		...
		'primary-bg': 'oklch(0.28 0.08 135)',
		'primary-fg': 'oklch(0.92 0.04 130)',
		'primary-light': 'oklch(0.32 0.10 135)',
		'on-primary': 'oklch(0.14 0.04 135)',
		'secondary-bg': 'oklch(0.18 0.03 125)',
		'secondary-fg': 'oklch(0.82 0.06 125)',
		'input-border': 'oklch(0.52 0.08 130)',
		'input-bg': 'oklch(0.13 0.03 135)',
		'bg-alpha': 'oklch(0.16 0.04 135 / 0.95)',
		'fg-alpha': 'oklch(0.88 0.08 125 / 0.1)',
		'surface-0': 'oklch(0.16 0.04 135)',
...
const P5: Palette = {
	...
	light: defineColors({
		...
		'primary-bg': 'oklch(0.88 0.07 290)',
		'primary-fg': 'oklch(0.20 0.10 295)',
		'primary-light': 'oklch(0.65 0.14 290)',
		'on-primary': 'oklch(0.96 0.02 290)',
		'secondary-bg': 'oklch(0.86 0.04 310)',
		'secondary-fg': 'oklch(0.24 0.06 310)',
		'input-border': 'oklch(0.46 0.10 290)',
		'input-bg': 'oklch(0.93 0.04 290)',
		'bg-alpha': 'oklch(0.94 0.06 290 / 0.95)',
		'fg-alpha': 'oklch(0.22 0.08 295 / 0.1)',
		'surface-0': 'oklch(0.94 0.06 290)',
	...
	dark: defineColors({
		...
		'primary-bg': 'oklch(0.26 0.10 290)',
		'primary-fg': 'oklch(0.92 0.03 285)',
		'primary-light': 'oklch(0.32 0.10 290)',
		'on-primary': 'oklch(0.12 0.04 290)',
		'secondary-bg': 'oklch(0.18 0.03 310)',
		'secondary-fg': 'oklch(0.80 0.05 310)',
		'input-border': 'oklch(0.50 0.08 290)',
		'input-bg': 'oklch(0.12 0.03 290)',
		'bg-alpha': 'oklch(0.15 0.04 290 / 0.95)',
		'fg-alpha': 'oklch(0.86 0.06 285 / 0.1)',
		'surface-0': 'oklch(0.15 0.04 290)',
...
const P6: Palette = {
	...
	light: defineColors({
		...
		'primary-bg': 'oklch(0.88 0.07 25)',
		'primary-fg': 'oklch(0.20 0.08 20)',
		'primary-light': 'oklch(0.66 0.12 25)',
		'on-primary': 'oklch(0.96 0.02 25)',
		'secondary-bg': 'oklch(0.86 0.04 40)',
		'secondary-fg': 'oklch(0.24 0.06 40)',
		'input-border': 'oklch(0.48 0.10 25)',
		'input-bg': 'oklch(0.92 0.05 25)',
		'bg-alpha': 'oklch(0.93 0.07 25 / 0.95)',
		'fg-alpha': 'oklch(0.22 0.06 20 / 0.1)',
		'surface-0': 'oklch(0.93 0.07 25)',
	...
	dark: defineColors({
		...
		'primary-bg': 'oklch(0.28 0.08 25)',
		'primary-fg': 'oklch(0.92 0.03 30)',
		'primary-light': 'oklch(0.34 0.08 25)',
		'on-primary': 'oklch(0.14 0.04 25)',
		'secondary-bg': 'oklch(0.18 0.03 40)',
		'secondary-fg': 'oklch(0.80 0.05 40)',
		'input-border': 'oklch(0.52 0.08 25)',
		'input-bg': 'oklch(0.13 0.03 25)',
		'bg-alpha': 'oklch(0.16 0.04 25 / 0.95)',
		'fg-alpha': 'oklch(0.86 0.06 30 / 0.1)',
		'surface-0': 'oklch(0.16 0.04 25)',
...
const P7: Palette = {
	...
	light: defineColors({
		...
		'primary-bg': 'oklch(0.88 0.06 265)',
		'primary-fg': 'oklch(0.18 0.10 265)',
		'primary-light': 'oklch(0.65 0.15 265)',
		'on-primary': 'oklch(0.96 0.02 260)',
		'secondary-bg': 'oklch(0.86 0.03 280)',
		'secondary-fg': 'oklch(0.22 0.06 280)',
		'input-border': 'oklch(0.46 0.08 260)',
		'input-bg': 'oklch(0.93 0.03 260)',
		'bg-alpha': 'oklch(0.94 0.04 260 / 0.95)',
		'fg-alpha': 'oklch(0.20 0.06 265 / 0.1)',
		'surface-0': 'oklch(0.94 0.04 260)',
	...
	dark: defineColors({
		...
		'primary-bg': 'oklch(0.24 0.10 265)',
		'primary-fg': 'oklch(0.92 0.04 255)',
		'primary-light': 'oklch(0.30 0.12 265)',
		'on-primary': 'oklch(0.10 0.04 260)',
		'secondary-bg': 'oklch(0.16 0.03 280)',
		'secondary-fg': 'oklch(0.82 0.05 280)',
		'input-border': 'oklch(0.52 0.08 260)',
		'input-bg': 'oklch(0.10 0.03 260)',
		'bg-alpha': 'oklch(0.12 0.04 260 / 0.95)',
		'fg-alpha': 'oklch(0.88 0.06 255 / 0.1)',
		'surface-0': 'oklch(0.12 0.04 260)',
