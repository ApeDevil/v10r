...
const P0: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.4 0.098 265)',
		'accent-hover': 'oklch(0.34 0.098 265)',
		'on-accent': 'oklch(0.95 0.015 265)',
		'accent-container': 'oklch(0.75 0.044 265)',
		'on-accent-container': 'oklch(0.2 0.013 265)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.72 0.091 265)',
		'accent-hover': 'oklch(0.66 0.091 265)',
		'on-accent': 'oklch(0.2 0.027 265)',
		'accent-container': 'oklch(0.95 0.041 265)',
		'on-accent-container': 'oklch(0.2 0.012 265)',
...
const P1: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.5 0.091 185)',
		'accent-hover': 'oklch(0.44 0.091 185)',
		'on-accent': 'oklch(0.95 0.014 185)',
		'accent-container': 'oklch(0.85 0.041 185)',
		'on-accent-container': 'oklch(0.2 0.012 185)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.65 0.078 180)',
		'accent-hover': 'oklch(0.59 0.078 180)',
		'on-accent': 'oklch(0.2 0.023 180)',
		'accent-container': 'oklch(0.95 0.035 180)',
		'on-accent-container': 'oklch(0.2 0.011 180)',
...
const P2: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.55 0.104 355)',
		'accent-hover': 'oklch(0.49 0.104 355)',
		'on-accent': 'oklch(0.95 0.015 355)',
		'accent-container': 'oklch(0.9 0.047 355)',
		'on-accent-container': 'oklch(0.2 0.014 355)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.68 0.091 355)',
		'accent-hover': 'oklch(0.62 0.091 355)',
		'on-accent': 'oklch(0.2 0.027 355)',
		'accent-container': 'oklch(0.95 0.041 355)',
		'on-accent-container': 'oklch(0.2 0.012 355)',
...
const P3: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.48 0.078 110)',
		'accent-hover': 'oklch(0.42 0.078 110)',
		'on-accent': 'oklch(0.95 0.012 110)',
		'accent-container': 'oklch(0.83 0.035 110)',
		'on-accent-container': 'oklch(0.2 0.011 110)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.62 0.065 105)',
		'accent-hover': 'oklch(0.56 0.065 105)',
		'on-accent': 'oklch(0.2 0.019 105)',
		'accent-container': 'oklch(0.95 0.029 105)',
		'on-accent-container': 'oklch(0.2 0.009 105)',
...
const P4: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.55 0.13 90)',
		'accent-hover': 'oklch(0.49 0.13 90)',
		'on-accent': 'oklch(0.95 0.015 90)',
		'accent-container': 'oklch(0.9 0.059 90)',
		'on-accent-container': 'oklch(0.2 0.018 90)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.72 0.117 90)',
		'accent-hover': 'oklch(0.66 0.117 90)',
		'on-accent': 'oklch(0.2 0.03 90)',
		'accent-container': 'oklch(0.95 0.053 90)',
		'on-accent-container': 'oklch(0.2 0.016 90)',
...
const P5: Palette = {
	...
	light: defineColors({
		...
		'accent-hover': 'oklch(0.42 0.13 245)',
		'on-accent': 'oklch(0.95 0.015 245)',
		'accent-container': 'oklch(0.83 0.059 245)',
		'on-accent-container': 'oklch(0.2 0.018 245)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.68 0.117 245)',
		'accent-hover': 'oklch(0.62 0.117 245)',
		'on-accent': 'oklch(0.2 0.03 245)',
		'accent-container': 'oklch(0.95 0.053 245)',
		'on-accent-container': 'oklch(0.2 0.016 245)',
...
const P6: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.52 0.117 70)',
		'accent-hover': 'oklch(0.46 0.117 70)',
		'on-accent': 'oklch(0.95 0.015 70)',
		'accent-container': 'oklch(0.87 0.053 70)',
		'on-accent-container': 'oklch(0.2 0.016 70)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.68 0.104 70)',
		'accent-hover': 'oklch(0.62 0.104 70)',
		'on-accent': 'oklch(0.2 0.03 70)',
		'accent-container': 'oklch(0.95 0.047 70)',
		'on-accent-container': 'oklch(0.2 0.014 70)',
...
const P7: Palette = {
	...
	light: defineColors({
		...
		accent: 'oklch(0.52 0.143 310)',
		'accent-hover': 'oklch(0.46 0.143 310)',
		'on-accent': 'oklch(0.95 0.015 310)',
		'accent-container': 'oklch(0.87 0.064 310)',
		'on-accent-container': 'oklch(0.2 0.019 310)',
	...
	dark: defineColors({
		...
		accent: 'oklch(0.72 0.143 310)',
		'accent-hover': 'oklch(0.66 0.143 310)',
		'on-accent': 'oklch(0.2 0.03 310)',
		'accent-container': 'oklch(0.95 0.064 310)',
		'on-accent-container': 'oklch(0.2 0.019 310)',
