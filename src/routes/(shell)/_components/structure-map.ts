...
export const sections: StructureSection[] = [
	{
		...
		groups: [
			...
			},
			{
				...
				intro: 'Each directory has a README.md navigation hub — brief intro, then a topic table linking to specific files.',
				items: [
					{ segments: [{ label: 'docs/foundation/', href: null }], description: 'core concepts & conventions' },
					{ segments: [{ label: 'docs/stack/', href: '/docs/stack' }], description: 'technology documentation per layer' },
	...
	},
	{
		...
		groups: [
			...
			},
			{
				...
				title: 'Components',
				items: [
					{ segments: [{ label: 'primitives/', href: '/showcases/ui/components/primitives' }], description: 'atomic UI elements (accordion, button, input...)' },
					{ segments: [{ label: 'composites/', href: '/showcases/ui/components/composites' }], description: 'assembled patterns (data-table, sidebar...)' },
					{ segments: [{ label: 'layout/', href: '/showcases/ui/layouts' }], description: 'page structure (stack, grid, divider...)' },
					{ segments: [{ label: 'shell/', href: '/showcases/shell/sidebar' }], description: 'app chrome (nav, footer, theme)' },
					{ segments: [{ label: 'viz/', href: '/showcases/viz' }], description: 'charts & 3D (lazy-loaded, excluded from barrel)' }
				]
			},
			{
				value: 'claude',
