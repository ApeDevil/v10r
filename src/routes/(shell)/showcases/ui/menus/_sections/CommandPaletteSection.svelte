<script lang="ts">
	...
	const sampleItems: CommandPaletteItem[] = [
		...
		{ id: 'p1', type: 'panel', label: 'Sidebar', icon: 'i-lucide-panel-left', hint: 'Shell', href: '/showcases/shell/sidebar' },
		...
		{ id: 'a2', type: 'action', label: 'Open Shortcuts', icon: 'i-lucide-keyboard', shortcut: 'Ctrl+/', action: () => {} },
	];
