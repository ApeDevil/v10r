<!--
	Tabbed Chart/Data/Code demo wrapper — same component as showcases/viz/_components/VizDemoCard.svelte.
	Copied rather than imported: _components/ folders are private to the route subtree that
	owns them, and reaching across top-level showcase folders has no precedent.
-->
<script lang="ts">
