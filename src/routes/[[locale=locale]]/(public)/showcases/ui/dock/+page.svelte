...
import type { ActivityBarItem, LayoutNode, PanelDefinition } from '$lib/components/desk';
...
const sections = $derived([
	{ id: 'dock-interactive', label: m.showcase_ui_dock_section_dock() },
	{ id: 'dock-features', label: m.showcase_ui_dock_section_features() },
]);
</script>
<NavSection {sections} />

<main class="content">
	<section id="dock-interactive">
		<h2 class="text-fluid-2xl font-bold mb-fluid-3">{m.showcase_ui_dock_section_dock()}</h2>
	...
	<section id="dock-features">
		<h2 class="text-fluid-2xl font-bold mb-fluid-3">{m.showcase_ui_dock_section_features()}</h2>

		<div class="grid grid-cols-1 md:grid-cols-2 gap-fluid-4">
			<Card>
				<h3 class="text-fluid-lg font-semibold mb-2">{m.showcase_ui_dock_card_drag_drop()}</h3>
			...
			<Card>
				<h3 class="text-fluid-lg font-semibold mb-2">{m.showcase_ui_dock_card_layout_control()}</h3>
				<ul class="list-disc list-inside text-fluid-sm text-muted space-y-1">
			...
			<Card>
				<h3 class="text-fluid-lg font-semibold mb-2">{m.showcase_ui_dock_card_keyboard()}</h3>
				<ul class="list-disc list-inside text-fluid-sm text-muted space-y-1">
			...
			<Card>
				<h3 class="text-fluid-lg font-semibold mb-2">{m.showcase_ui_dock_card_architecture()}</h3>
				<ul class="list-disc list-inside text-fluid-sm text-muted space-y-1">
