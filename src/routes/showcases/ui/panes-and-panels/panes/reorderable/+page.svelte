<script lang="ts">
	import { PageHeader, Card, BackLink, ReorderablePaneLayout } from '$lib/components';
...
<div class="page">
	<PageHeader
		...
		description="Drag-to-reorder pane layouts. Tab bar handles reorder, PaneForge handles resize. Supports keyboard reorder, persistence, and accessibility."
		breadcrumbs={[
			{ label: 'Home', href: '/' },
			{ label: 'Showcases', href: '/showcases' },
			{ label: 'UI', href: '/showcases/ui' },
			{ label: 'Panes & Panels', href: '/showcases/ui/panes-and-panels' },
			{ label: 'Panes', href: '/showcases/ui/panes-and-panels/panes' },
			{ label: 'Reorderable' }
		]}
	/>
	...
	<BackLink href="/showcases/ui/panes-and-panels/panes" label="Panes" />
</div>
